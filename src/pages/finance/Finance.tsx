      ...
      <SafeArea>
        ...
        <Section>
          <TitleRow>
            ...
            <Right>
              <TinyPlus src={plusIcon} alt="추가" onClick={() => navigate('/quiz')} />
            </Right>
          </TitleRow>

          <CardQuiz>
            <CardBody>
              <CardTop>Q. 신용점수를 올리려면 어떻게 해야 할까요?</CardTop>
              <Q_CardTitle>① 연체하지 않기 ② 카드 많이 만들기 ③ 대출 자주 받기</Q_CardTitle>
            </CardBody>
          </CardQuiz>
